...
def insert_history_mat(History_Job_ID,job,startTime,ENDTIME,status,RunDate,Sche_or_Manu,description):
	try:
		...
		DashBoard_History_Logs.objects.create(JobType='MatillionJobs',JobID=History_Job_ID,JobName=job,StartTime=startTime,EndTime=ENDTIME,Status=status,RunDate=RunDate,Sche_or_Manu=Sche_or_Manu,description=description)
	except Exception as E:
	...
	try:
		...
		while True:
			if status=='SUCCESS' or status=='FAILED':
				...
				DashBoard_History_Logs.objects.create(JobType='MatillionJobs',JobID=History_Job_ID,JobName=job,StartTime=startTime,EndTime=ENDTIME,Status=status,RunDate=RunDate,Sche_or_Manu=Sche_or_Manu,description=status)
...
def insert_history_py(History_Job_ID,job,startTime,ENDTIME,status,RunDate,Sche_or_Manu,description):
	try:
		...
		DashBoard_History_Logs.objects.create(JobType='PythonJobs',JobID=History_Job_ID,JobName=job,StartTime=startTime,EndTime=ENDTIME,Status=status,RunDate=RunDate,Sche_or_Manu=Sche_or_Manu,description=description)
	except Exception as E:
...
def insert_history_tal(History_Job_ID,job,startTime,ENDTIME,status,RunDate,Sche_or_Manu,description):
	try:
		...
		DashBoard_History_Logs.objects.create(JobType='TalendJobs',JobID=History_Job_ID,JobName=job,StartTime=startTime,EndTime=ENDTIME,Status=status,RunDate=RunDate,Sche_or_Manu=Sche_or_Manu,description=description)
	except Exception as e:
...
def MatillionScedule(request,*args,**kwargs):
	print('*********************************in MatillionScedule************************************')
	log.debug('*********************************in MatillionScedule************************************')
	try:
		obj=MatillionJobInformation.objects.all().order_by('-id')
		print(obj[0].JobName)
		#StartMatilionJobUtil()
...
def TalendScedule(request,*args,**kwargs):
	print('*********************************in TalendScedule************************************')
	log.debug('*********************************in TalendScedule************************************')
	try:
		obj=TalendJobInformations.objects.all().order_by('-id')
		print('obj************************'+str(obj))
		print(obj[0].JobName)
...
def insert_history_custom(row,status,startTime,Sche_or_Manu,description):
	...
	DashBoard_History_Logs.objects.create(JobID=row.id,JobName=row.JobName,StartTime=startTime,EndTime=GetStartEndDateDate(),Status=status,RunDate=GetRunDate(),Sche_or_Manu=Sche_or_Manu,description=description)
...
def GetHistoryLogs(request,*args,**kwargs):
	...
	'''
	l=[]
	obj=DashBoard_History_Logs.objects.all().order_by('-id')
	for i in obj:
		d={'JobType':i.JobType,'JobID':i.JobID,'JobName':i.JobName,'StartTime':i.StartTime,'EndTime':i.EndTime,'Status':i.Status,'Sche_or_Manu':i.Sche_or_Manu,'description':i.description}
		l.append(d)
