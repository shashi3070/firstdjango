...
from .models import DashBoard_History_Logs,Custom_Run_JobHistory,CustomJobInformations,TalendJobInformations,Talend_Run_JobHistory,Contacts,index_data,MatJobInformation,MatillionJobInformation,Matilion_Run_JobHistory,PythonJobInformations,Python_Run_JobHistory
...
admin.site.register(DashBoard_History_Logs)
