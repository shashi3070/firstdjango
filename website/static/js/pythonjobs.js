$(document).ready(function() {
    ...
    $('#Details_TableID').DataTable({
        "pageLength": 5,
         columnDefs: [
                        ...
                        {targets: 1,render: $.fn.dataTable.render.ellipsis(40) },
    ...
    $('#Details_TableID').on('click', '.SeeJobiDCred', function(e) {
        ...
        console.log(e)
        debugger;
        window.open('/admin/website/pythonjobinformations/' + Id + '/change/', '_self');
    ...
    $('#Details_TableID').on('click', '.tempclass3', function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                //console.log(data+'--------------------jhsgdjasggh'+data)
                ...
                console.log('html content ' + trHTML)
