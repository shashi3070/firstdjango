...
if __name__=='__main__':  
    #CNV_SalesIQ_Team@Axtria.onmicrosoft.com 
    #CST@2020
    #Ethicon_salesiq_team@Axtria.onmicrosoft.com
    #D9',g[tQcPZfCVx9
    SendMailWithoutAttachment('CNV_SalesIQ_Team@Axtria.onmicrosoft.com','This is test function',"CST@2020",['shashi.kundan@axtria.com'])
